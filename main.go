...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			...
			EnvVar: "DRONE_REPO,GITHUB_REPOSITORY,CI_REPO",
		},
		cli.StringFlag{
			Name:   "repo.namespace",
			Usage:  "repository namespace",
			EnvVar: "DRONE_REPO_OWNER,DRONE_REPO_NAMESPACE,GITHUB_ACTOR,CI_REPO_OWNER",
		},
		cli.StringFlag{
			Name:   "repo.name",
		...
		cli.StringFlag{
			...
			EnvVar: "DRONE_COMMIT_SHA,GITHUB_SHA,CI_COMMIT_SHA",
		},
		cli.StringFlag{
			Name:   "commit.ref",
			Usage:  "git commit ref",
			EnvVar: "DRONE_COMMIT_REF,GITHUB_REF,CI_COMMIT_REF",
		},
		cli.StringFlag{
			Name:   "commit.branch",
			Value:  "master",
		...
		cli.StringFlag{
			...
			EnvVar: "DRONE_COMMIT_LINK,CI_COMMIT_URL",
		},
		cli.StringFlag{
			Name:   "commit.author",
		...
		cli.Int64Flag{
			Name:   "build.started",
			Usage:  "build started",
			EnvVar: "DRONE_STAGE_STARTED,CI_PIPELINE_STARTED",
		},
		cli.Int64Flag{
			Name:   "build.finished",
...
func run(c *cli.Context) error {
	plugin := Plugin{
		...
		Build: Build{
			...
			PrevStatus: c.String("prev.build.status"),
		},
		Config: Config{
